			...
			<form class="bg-white">
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
						...
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
							d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />						</svg>
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
						...
						<path fill-rule="evenodd"
							...
							<button type="submit" class="block w-full bg-purple-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Signin</button>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" preserveAspectRatio="none" viewBox="0 0 150 150">
						...
						<button type="submit"  class=" text-gray-400" >Sign in with Google</button>
							...
							<span class="text-sm ml-2 text-purple-900 hover:text-black-500 cursor-pointer font-semibold mb-2">Already have an account ? Login </span>
